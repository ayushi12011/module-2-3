...
public class Question12 {
	    ...
	    public Question12(String name, int age, String phoneNumber, String address, double salary) {
	        this.name = name;
	        this.age = age;
...
public class Employee extends Question12 {
	...
	public class Manager extends Question12{
