...
{  
			...
			<div class="inner-header">
				...
				<nav class="main-menu mobile-menu">
					<ul>
						...
						<li><a href="registre.jsp">Registration</a></li>
	...
	<div class="contact-section">
		<div class="container">
			<div class="row">
				<div class="col-lg-8">
					<form action="customercontroller" method="post" name="vinform">
			<div class="mb-3">
				<label for="exampleInputEmail1" class="form-label">Fname: </label> <input
					type="text" class="form-control" name="fname" onblur="searchInfo()"
			...
			<div class="mb-3">
				<label for="exampleInputEmail1" class="form-label">Email: </label> <input
					type="email" class="form-control" name="email" onblur="searchInfo()"
					id="exampleInputEmail1" aria-describedby="emailHelp">
